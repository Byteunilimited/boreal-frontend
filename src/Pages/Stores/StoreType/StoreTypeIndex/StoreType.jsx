...
import '../../StoreIndex/Store.css';
import { AddNewStoreType } from '../ActionsStoreType/AddStoreType/AddNewStoreType';
import { UpdateStoreType } from '../ActionsStoreType/UpdateStoreType/UpdateStoreType';
...
export const StoreType = () => {
    ...
    const handleUpdate = (updatedItem) => {
        setData((prevData) =>
            prevData.map(item => item.Código === updatedItem.id ? {
                Código: updatedItem.id,
                Nombre: updatedItem.description,
            } : item)
        );
        setShowModalStoreType(false); 
    };
